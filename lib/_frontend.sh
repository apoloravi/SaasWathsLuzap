...
frontend_node_dependencies() {
  ...
  sudo su - root <<EOF
  cd /home/${instancia_add}/frontend
  npm install
EOF
...
frontend_update() {
  ...
  sudo su - root <<EOF
  cd /home/${empresa_atualizar}
  pm2 stop ${empresa_atualizar}-frontend
  git pull
  cd /home/${empresa_atualizar}/frontend
  npm install
  rm -rf build
  npm run build
...
sudo su - root << EOF
  cat <<[-]EOF > /home/root/${instancia_add}/frontend/.env
...
sudo su - root << EOF
  cat <<[-]EOF > /home/root/${instancia_add}/frontend/server.js
